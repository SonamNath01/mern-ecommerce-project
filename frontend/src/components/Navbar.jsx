    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      >
        <div className="flex flex-col text-gray-600">
          ...
          <NavLink onClick={() => setVisible(false)} className="py-6 pl-6 border-b" to="/">
            Home
          </NavLink>
          <NavLink onClick={() => setVisible(false)} className="py-6 pl-6 border-b" to="/collection">
            COLLECTION
          </NavLink>
          <NavLink onClick={() => setVisible(false)} className="py-6 pl-6 border-b" to="/about">
            ABOUT
          </NavLink>
          <NavLink onClick={() => setVisible(false)} className="py-6 pl-6 border-b" to="/contact">
            Contact
          </NavLink>
        </div>
      </div>
