    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value='Topwear' /> <span>Topwear</span>
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value='Bottomwear' /> <span>Bottomwear</span>
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type='checkbox' value='Winterwear' /> <span>Winterwear</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className='flex-1'>
        ...
        <div className='flex justify-between items-center text-base sm:text-2xl mb-4'>
          ...
          <select className='border-2 border-gray-300 text-sm px-3 py-1 rounded-md hover:border-gray-400 transition-all duration-200 cursor-pointer'>
